...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mecánica automotriz en Osorno con precios convenientes: servicio a domicilio y taller en Las Quemas KM 5. Frenos, aceite, scanner, tren delantero y reparaciones confiables." },
      { name: "keywords", content: "mecánica automotriz osorno, mecánico a domicilio osorno, mecánica barata osorno, taller mecánico osorno, cambio de aceite osorno, reparación de frenos osorno" },
      ...
      { property: "og:description", content: "Mecánica automotriz en Osorno con precios convenientes y atención a domicilio. Frenos, aceite, scanner y más." },
      { name: "twitter:description", content: "Mecánica automotriz en Osorno con precios convenientes y atención a domicilio. Frenos, aceite, scanner y más." },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        description: "Servicio de mecánica automotriz en Osorno, con diagnóstico y reparación a domicilio o en taller propio.",
        areaServed: {
          "@type": "City",
          name: "Osorno",
        },
